...
const wdbtn4 = document.getElementById("wd_projectLink3");
const wdbtn5 = document.getElementById("wd_projectLink4");
...
wdbtn4.addEventListener("click", (event) => {
  event.preventDefault();
  window.open("https://chorestodo.herokuapp.com/");
});

wdbtn5.addEventListener("click", (event) => {
  event.preventDefault();
  window.open("https://letthemeatcake.herokuapp.com/");
});
